// Da se kreira aplikacija slicna na zadacata
// od casot za TODOs, da imame nekoja pocetna lista
// so avtomobili i da imame moznost za dodavanje
// na nov avtomobil vo taa lista. 
// Do sekoj avtomobil od listata da ima kopce Buy
// so koe bi se kupil avtomobilot i bi se prefrlil 
// vo drugata lista odnosno listata na OWned Cars
...
export const Cars = () => {
    const initialListOfCars = [
        {id:1, brand: "BMW", quantity:5},
        {id:2, brand: "Mercedes", quantity:5},
        {id:3, brand: "Audi", quantity:5},
    ];

 // Go koristite "useState" za cuvanje na sostojbata na komponentata
  // "carsForSale" ke sodrzi lista na avtomobili za prodazba,
  // "ownedCars" ke sodrzi lista na avtomobili koi se kupeni, 
  //a "newBrand" ke go cuva tekstot od vneseniot nov brend na avtomobil

  const [carsForSale, setCarsForSale] = useState(initialListOfCars);
